...
import style from '../scss/Lessons.module.scss'
...
function Lessons() {
    ...
    return (
        <div className={`mainContainer ${styles.container}`} id='app'>
            ...
            <section className={styles.lessons}>
                <div className={styles.lessonsWrapper}>
                    ...
                    <div className={style.card}>
                        ...
                        <p className={style.title}>Задание №{lessonId}</p>
                    </div>
                        ...
                        <div className={style.test}>
                            ...
                            <form className={style.form} autoComplete='off'>
                                <div className={style.input}>
                                    <input type='text' className={style.inputField} required autoComplete='off' />
                                    <label className={style.inputLabel}>Введите ответ</label>
                                </div>
                                <button className={style.actionButton}>Отправить</button>
                            </form>
                        </div>
                    </div>
                    <div className={style.pagination}>
                        <div
                            ...
                            className={`${style.arrow} ${activeBtn === 1 && style.endPoint}`}
                        >
                            &#11164;
                        </div>
                        <div
                            onClick={() => setActiveBtn(1)}
                            className={activeBtn === 1 ? `${style.activeBtn}` : undefined}
                        >
                            1
                        </div>
                        <div
                            onClick={() => setActiveBtn(2)}
                            className={activeBtn === 2 ? `${style.activeBtn}` : undefined}
                        >
                            2
                        </div>
                        <div
                            onClick={() => setActiveBtn(3)}
                            className={activeBtn === 3 ? `${style.activeBtn}` : undefined}
                        >
                            3
                        </div>
                        <div
                            onClick={() => activeBtn !== 3 && setActiveBtn((prev) => prev + 1)}
                            className={`${style.arrow} ${activeBtn === 3 && style.endPoint}`}
                        >
                            &#11166;
                        </div>
                    </div>
            ...
            <aside className={styles.lessonsNav}>
